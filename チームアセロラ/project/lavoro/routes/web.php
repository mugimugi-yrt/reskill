...
Route::group(['middleware' => ['auth']], function () {
    ...
    // ユーザー : 予約関連
    Route::resource('reservations', ReservationController::class, ['only' => ['index', 'edit', 'store']]);
    Route::post('reservations/create', [ReservationController::class,'create'])->name('reservations.create');
    Route::patch('reservations/update/{id}', [ReservationController::class,'update'])->name('reservations.update');
